...
plastic_data_all %>% group_by(region) %>% 
  mutate(total_mismanaged_plastic = mismanaged_plastic * population) %>% 
      summarise(sum(total_mismanaged_plastic))
...
plastic_data_all %>% mutate(pct_mismanaged_plastic_ocean = mismanaged_plastic_ocean / 
                              mismanaged_plastic * 100) %>% drop_na() %>% group_by(region)  %>% 
                  summarise(median_waste = median(pct_mismanaged_plastic_ocean))
